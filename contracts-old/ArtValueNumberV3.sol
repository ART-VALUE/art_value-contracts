    ...
    OwnableUpgradeable
{
    ...
    function initializeV3Only() public {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "ArtValueNumber: must have default_admin role to initialize V3");
        require(!v3Initialized, "ArtValueNumber: contract instance has already been initialized for V3");
